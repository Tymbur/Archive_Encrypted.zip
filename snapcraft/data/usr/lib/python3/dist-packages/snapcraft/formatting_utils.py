...
def format_path_variable(
    ...
    if separator.isspace():
        formatted = '{envvar}="${envvar}{separator}{combined_paths}"'.format(
            envvar=envvar, separator=separator, combined_paths=combined_paths
        )
    else:
        formatted = '{envvar}="${{{envvar}:+${envvar}{separator}}}{combined_paths}"'.format(
            envvar=envvar, separator=separator, combined_paths=combined_paths
        )
